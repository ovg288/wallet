...
class USDBalanceChangeMakerMoneyService implements BalanceChangeMakerMoneyServiceInterface
{
    ...
    #[Override] public function createMoney(Wallet $wallet, Money $balanceChangeMoney): Money
    {
        $usdCurrency = Currency::create(CurrencyEnum::USD->value);

        if (!$balanceChangeMoney->getCurrency()->equalsTo($usdCurrency)) {
